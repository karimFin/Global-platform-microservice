...
const services = [
  {
    ...
    path: '/health',
    status: 'healthy',
    description: 'Unified entry point for all APIs.',
  },
  {
    name: 'Identity',
    port: 9001,
    path: '/health',
    status: 'healthy',
    description: 'Auth, sessions, and access control.',
  },
  {
    name: 'Seller',
    port: 9002,
    path: '/health',
    status: 'healthy',
    description: 'Seller onboarding and profiles.',
  },
  {
    name: 'Catalog',
    port: 9003,
  ...
  },
  {
    ...
    path: '/health',
    status: 'healthy',
    description: 'Search indexing and queries.',
  },
  {
    name: 'Pricing',
    port: 9005,
    path: '/health',
    status: 'healthy',
    description: 'Pricing rules and promotions.',
  },
  {
    name: 'Inventory',
    port: 9006,
  ...
  },
  {
    ...
    path: '/health',
    status: 'healthy',
    description: 'Cart lifecycle and items.',
  },
  {
    name: 'Checkout',
    port: 9008,
  ...
  },
  {
    ...
    path: '/health',
    status: 'healthy',
    description: 'Fulfillment workflows.',
  },
  {
    name: 'Notifications',
    port: 9012,
    path: '/health',
    status: 'healthy',
    description: 'Email and event notifications.',
  },
  {
    name: 'Reviews',
    port: 9013,
