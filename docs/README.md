...
## ১৪) ফুল টেকনিক্যাল আর্কিটেকচার (GIF + Deep Dive)
- বিস্তারিত ইংরেজি আর্কিটেকচার গাইড: `docs/ARCHITECTURE_DEEP_DIVE.md`
- অ্যানিমেটেড আর্কিটেকচার GIF: `docs/assets/global-marketplace-architecture.gif`

## ১৫) Platform SRE + Grafana (FAANG-style)
- SRE implementation guide: `docs/PLATFORM_SRE_FAANG_IMPLEMENTATION.md`
- Grafana Kubernetes manifests: `platform/k8s/observability/grafana/`
- Quick commands: `make grafana-install`, `make grafana-port-forward`, `make grafana-uninstall`
